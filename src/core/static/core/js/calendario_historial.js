document.addEventListener('DOMContentLoaded', function() {
    ...
    /*GRAFICO DE ESTADISTICAS INICIA AQUI*/
    var fechasData = JSON.parse(document.getElementById('fechas-data').textContent);
    var pesosData = JSON.parse(document.getElementById('pesos-data').textContent);
    var ctx = document.getElementById('graficoPesos').getContext('2d');
